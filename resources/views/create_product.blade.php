        ...
        <form>
          <div class="d-flex">
            ...
            <div>
              <div class="d-flex mt-2" style="width: 10% !important;">
                <div class="pe-3 ps-2">
                  <a href="">
                    <button class="btn btn-primary" style="padding: 3px 9px;"><i class="fa fa-plus" aria-hidden="true"></i></button>
                  </a>
                </div>
                <div class="">
                  <a href="">
                    <button class="btn btn-danger" style="padding: 3px 9px;"><i class="fa fa-minus" aria-hidden="true"></i></button>
                  </a>
                </div>
              </div>
          ...
          <div class="row my-3">
            <div class="col-sm-12 text-center">
              <button type="submit" class="btn btn-primary"><i class="fa-solid fa-square-plus me-2"></i>Create</button>
            </div>
          </div>
